...
This file governs **devseed itself** and is not shipped in the plugin. Consumer
projects receive the four seed documents from
`plugins/governed-dev/templates/`, and decide their own conventions. Whether a
ledger rule should ship to consumers is undecided — it is not a gap this rule
