...
- **Date:** 2026-08-11
- **Status:** Accepted as a record. **The removals it recommends are not
  decided** — they await human approval, and those touching §5's check table
  additionally require `/amend` per §6.
